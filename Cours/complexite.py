...
# notation de Landau : O() (Lettre O, pas le chiffre ) 
...
words =['anana','banane','cerise', 'durian', 'kiwi', 'orange' , 'pomme' ] 

#O(n)
# n est la quantité de données à traiter de la premiere liste
# m est la quantité de données à traiter de la deuxieme liste
# numbers = [123, 42, 3.14]
...
#     #number == 42 
#     for more_number in more_number:
